...
size -> attribute defines the number of characters that should be visible as the user types into the input || should be non-negative || if not set browser will set a default 
